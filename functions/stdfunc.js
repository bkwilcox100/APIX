...
//
//   }
//   var fileName = destPath + util.getSQLTimeStamp() + "_" + util.getServiceName(doc) + ".sql";
...
//             if (sourceDoc["definitions"][arrayList[i]]["properties"][arrayPropList[j]]["items"].hasOwnProperty('$ref')){
